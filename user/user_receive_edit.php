...
<title>Management to accept the goods address-<?php echo $webname;?></title>
...
?>
	    ...
	    <h2>jiexu shop</h2>
    		...
    		<!--会员中心菜单结束-->	
		      <div class="main">
		        <h2 class="title">Management to accept the goods address</h2>
		        <div class="member_box_2">
		          <form action="user_receiveSava.php" method="post" name="form_add_consignee" id="fromadd">                  
		            <table border="0" cellpadding="5" cellspacing="5" width="100%">
		              <tbody>
		                <tr>
		                  <td width="15%" height="35"><input type="hidden" name="id" value="<?php echo $id;?>" /><input type="hidden" name="action" value="edit" />Sender:</td>
